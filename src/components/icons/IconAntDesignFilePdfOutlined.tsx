...
// By: ant-design
// See: https://v0.app/icon/ant-design/file-pdf-outlined
// Example: <IconAntDesignFilePdfOutlined width="24px" height="24px" style={{color: "#86600"}} />

export const IconAntDesignFilePdfOutlined = ({
  height = "1em",
  fill = "currentColor",
  focusable = "false",
  ...props
